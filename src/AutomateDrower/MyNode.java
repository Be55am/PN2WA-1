...
public class MyNode extends VBox {
    ...
    private void initPane() {
        ...
        markLabel.setPrefWidth(200);
        markLabel.setPrefHeight(30);
...
//            cubic.setStartX(StartLocation.getX() + (markLabel.getWidth() / 2));
//            cubic.setStartY(StartLocation.getY() + (markLabel.getHeight()));
//            cubic.setControlX1(0.0f);
//            cubic.setControlY1(0.0f);
//          cubic.setControlX2(0.0f);
//         cubic.setControlY2(0);
//            cubic.setEndX(location.getX() + (transition.getWidth() / 2));
//            cubic.setEndY(location.getY()
//                    + transition.getNameLabel().localToParent(0, 0).getY());
//
